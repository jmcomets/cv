...
\cvcomputer{Web}{Python (Django, Flask), JavaScript (serveur: ExpressJS;
    client: JQuery, AngularJS), Ruby (notions en Rails), PHP}{Base de
    données}{Oracle, MySQL, \\SQLite, MongoDB}
