...
\cventry{Mai à Août 2014}{Développeur Ruby On
...
\cventry{Juin à\\Septembre 2013}{Développeur C++}{LIRIS --
...
\cventry{Juillet à\\Août 2012}{Assistant à la saisie/Aide administrateur
...
\cvcomputer{Web}{Python (Django, Flask), JavaScript \\(AngularJS), Ruby on Rails, PHP}
    {Base de données}{MySQL, PostgreSQL, \\SQLite, MongoDB, Oracle}
\cvcomputer{POO}{C++, Python, Ruby, Java, JavaScript}
    {Impératif}{C, Pascal}
\cvcomputer{Outils}{Git, SVN, \\QMake, CMake}
    {Divers}{UML, Vim, Shell, \LaTeX, Linux}
